<x-jet-form-section submit="updateProfileInformation">
    ...
    <x-slot name="form">
        ...
        <!-- Mobile Telephone -->
        <div class="col-span-6 sm:col-span-4">
            <x-jet-label for="mobiletel" value="{{ __('Mobile telephone') }}" />
            <x-jet-input id="mobiletel" type="text" class="mt-1 block w-full" wire:model.defer="state.mobiletel" />
            <x-jet-input-error for="mobiletel" class="mt-2" />
        </div>

        <!-- Landline telephone -->
        <div class="col-span-6 sm:col-span-4">
            <x-jet-label for="landlinetel" value="{{ __('Landline telephone') }}" />
            <x-jet-input id="landlinetel" type="text" class="mt-1 block w-full" wire:model.defer="state.landlinetel" />
            <x-jet-input-error for="landlinetel" class="mt-2" />
        </div>
    </x-slot>
